...
try
{
	 ...
	 System.out.println("Connection Established");
	  ...
	  PreparedStatement pstmt = con.prepareStatement("select * from studentdetails where email_id=? and password=?");
	  pstmt.setString(1,email);
	  pstmt.setString(2,opwd);
	  ResultSet rs = pstmt.executeQuery();
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update studentdetails set password=? where email_id=?");
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="Studentlogin.html">Password Updated</a>
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="studentchangepwd.jsp">Password Not Updated</a>
        <a href="studentlogout.jsp">Logout</a>
 </div>
<div class="footer">
  <p>copy rights reserved &copy; Maheshaa</p>
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="studentchangepwd.jsp">Password Incorrect</a>
        <a href="studentlogout.jsp">Logout</a>
 </div>
<div class="footer">
  <p>copy rights reserved &copy; Maheshaa</p>
