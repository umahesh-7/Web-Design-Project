...
try
{
	 ...
	 System.out.println("Connection Established");
	  ...
	  if(rs.next())
	  {
		  PreparedStatement pstmt1 = con.prepareStatement("update admin set password=? where id=?");
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="adminlogin.html">Password Updated</a>
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="managerchangepwd.jsp">Password Not Updated</a>
        <a href="managerlogout.jsp">Logout</a>
 </div>
<div class="footer">
  <p>copy rights reserved &copy; Maheshaa</p>
...
<body bgcolor="yellow">
<div class="navbar">
 <a class="active" href="managerchangepwd1.jsp">Password Incorrect</a>
        <a href="managerlogout.jsp">Logout</a>
 </div>
<div class="footer">
  <p>copy rights reserved &copy; Maheshaa</p>
